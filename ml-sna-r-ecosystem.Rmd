...
## 1. R 생태계 사회망 분석 - R 팩키지 데이터  [^sna-r-ecosystem] [^network-viz-R] {#r-package-ecosystem}
...
## 2. 데이터 전처리 {#r-package-preprocessing}
...
## 3. 기초 통계량  {#r-package-ecosystem-basic-stat}
...
```{r ml-r-ecosystem-tree, tidy=FALSE, fig.width=12, fig.height=10}
